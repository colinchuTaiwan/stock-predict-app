...
def analyze_stock_logic(code, df):
    try:
        ...
        # 多頭排列判斷 
        if ma[5]>ma[10] > ma[20] > ma[60] > ma[100] > ma[200]:
            # 檢查這六條均線中，有幾條斜率是向上的 (ma_d > 0)
            ...
            signal = {
                ...
                3: "三線多排", 
                2: "二線多排"
            }.get(up_count, "均線多排") # 若只有 1 條或 0 條向上則給預設標籤
...
now = now_taipei()
SCHEDULE = ["00:00","01:00","03:00","08:30", "09:30", "10:30", "11:30", "12:30", "13:30","15:00","20:00","23:00"] 
current_slot = ""
for t in SCHEDULE:
