...
# 載入快取
df_cache,last_upd = load_cache()
st.session_state.df_results = df_cache if not df_cache.empty else st.session_state.df_results
...
if curr_min in SCHEDULE_TIMES and st.session_state.last_run_min != curr_min:
    ...
    if not new_results.empty:
        ...
        append_history(st.session_state.df_results)
    else:
